defmodule CircleCI.Error do
  ...
  errors returned from the CircleCI API (for example, Not Found errors).
  ...
  meanings:
    ...
    * `:not_found`: A resource or route was not found. Note that CircleCI may return this kind of
  ...
  @typedoc "CircleCI API client error"
  @type t :: %__MODULE__{
          code: integer | nil,
          message: String.t(),
