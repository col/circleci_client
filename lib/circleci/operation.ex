defmodule CircleCI.Operation do
  @moduledoc """
  ...
  > are useful for plugins. See `CircleCI.Plugin` for more information.
  ...
  @spec put_accept_header(t) :: t
  defp put_accept_header(operation) do
    put_request_header(operation, "Accept", "application/json")
  end
  ...
  defp put_user_agent(operation) do
    user_agent =
      IO.iodata_to_binary([
        ...
        " via circleci_client ",
        Application.spec(:circleci_client, :vsn),
        "; Elixir ",
        System.version(),
        " / OTP ",
        System.otp_release()
